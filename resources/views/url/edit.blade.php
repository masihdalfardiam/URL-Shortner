                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('url.update',$url->id) }}">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control @error('url') is-invalid @enderror" id="url" name="url" value="{{ old('url',$url->url) }}" placeholder="Exmaple : https://url.com" required autofocus>
                              @error('url')
